...
const createScene = (width, height, depth, thickness, withLid) => {
    ...
    material.diffuseTexture = new BABYLON.Texture("https://github.com/maxii1221/cajatapanormal/src/img/Wood037_2K-JPG_Color.jpg", scene);
    
    material.diffuseTexture.level = 1.5;
    material.bumpTexture = new BABYLON.Texture("https://github.com/maxii1221/cajatapanormal/src/img/Wood037_2K-JPG_Color.jpg", scene);
    ...
    materialDelantera.diffuseTexture = new BABYLON.Texture("https://github.com/maxii1221/cajatapanormal/src/img/Wood037_2K-JPG_Color.jpg", scene);
    ...
    materialBack.diffuseTexture = new BABYLON.Texture("https://github.com/maxii1221/cajatapanormal/src/img/Wood037_2K-JPG_Color.jpg", scene);
    ...
    materialIzquierda.diffuseTexture = new BABYLON.Texture("https://github.com/maxii1221/cajatapanormal/src/img/Wood037_2K-JPG_Color.jpg", scene);
    ...
    materialDerecha.diffuseTexture = new BABYLON.Texture("https://github.com/maxii1221/cajatapanormal/src/img/Wood037_2K-JPG_Color.jpg", scene);
    ...
    materialBase.diffuseTexture = new BABYLON.Texture("https://github.com/maxii1221/cajatapanormal/src/img/Wood037_2K-JPG_Color.jpg", scene);
