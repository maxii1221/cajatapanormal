...
const createScene = (width, height, depth, thickness, withLid) => {
    ...
    material.bumpTexture = new BABYLON.Texture("https://maxii1221.github.io/cajatapanormal/src/img/Wood0372KJPGNormalGL.jpg", scene);
    ...
    materialDelantera.diffuseTexture = new BABYLON.Texture("https://maxii1221.github.io/cajatapanormal/src/img/Wood0372KJPGColor.jpg", scene);
    ...
    materialBack.diffuseTexture = new BABYLON.Texture("https://maxii1221.github.io/cajatapanormal/src/img/Wood0372KJPGColor.jpg", scene);
    ...
    materialIzquierda.diffuseTexture = new BABYLON.Texture("https://maxii1221.github.io/cajatapanormal/src/img/Wood0372KJPGColor.jpg", scene);
    ...
    materialDerecha.diffuseTexture = new BABYLON.Texture("https://maxii1221.github.io/cajatapanormal/src/img/Wood0372KJPGColor.jpg", scene);
    ...
    materialBase.diffuseTexture = new BABYLON.Texture("https://maxii1221.github.io/cajatapanormal/src/img/Wood0372KJPGColor.jpg", scene);
